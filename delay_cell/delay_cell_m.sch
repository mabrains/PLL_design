...
C {devices/res.sym} -140 -80 0 0 {name=R5
value=800
footprint=1206
device=resistor
m=1}
...
C {sky130_fd_pr/pfet3_01v8.sym} -120 -180 0 1 {name=M4
L=0.15
W=1
body=VDD
nf=1
...
C {sky130_fd_pr/pfet3_01v8.sym} 280 -180 0 1 {name=M5
L=0.15
W=1
body=VDD
nf=1
...
C {sky130_fd_pr/pfet3_01v8.sym} 490 -180 0 1 {name=M6
L=0.15
W=1
body=VDD
nf=1
...
C {sky130_fd_pr/pfet3_01v8.sym} -300 -180 0 0 {name=M7
L=0.15
W=1
body=VDD
nf=1
...
C {sky130_fd_pr/pfet3_01v8.sym} -460 -180 0 0 {name=M8
L=0.15
W=1
body=VDD
nf=1
...
C {devices/ipin.sym} -530 -180 0 0 {name=p1 lab=vc}
C {devices/ipin.sym} -340 -180 0 0 {name=p2 lab=vf}
C {devices/ipin.sym} 330 -180 0 1 {name=p5 lab=vf}
