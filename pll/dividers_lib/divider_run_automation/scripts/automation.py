...
for N in range (N_start,N_end):
    ...
    with open(f"divider_tb_out.spice" , "w") as netlist:
        netlist.write(tmpl.render(f_in = f_in, p0 = p0, p1 = p1 , p2 = p2 , p3 = p3 ,p4 = p4, p5 = p5 , p6 = p6 , p7 = p7 ))
    # Running ngspice for each netlist 
    netlist_out = "divider_tb_out.spice"
...
for N in range (N_start, N_end):
    ...
    current_file= open (f"divider_tb_out.spice{y}.log", "r")
