...
freq_file = pd.read_csv ("vout_fft.csv",index_col=False,usecols=[0],header=None, delimiter=r"\s+")
freq_array = freq_file.to_numpy()
freq_array = freq_array.ravel()
freq_array = np.array(freq_array)

mag_file = pd.read_csv ("vout_fft.csv",index_col=False,usecols=[1],header=None, delimiter=r"\s+")
