...
ssff, = ax.plot(np.delete(vctrl , np.where(f_osc_ssff<=1000)[0]), np.delete(f_osc_ssff , np.where(f_osc_ssff<=1000)[0]), linewidth=2.5, label='ssff')
...
stff, = ax.plot(np.delete(vctrl , np.where(f_osc_stff<=1000)[0]), np.delete(f_osc_stff , np.where(f_osc_stff<=1000)[0]), linewidth=2.5, label='stff')
sttt, = ax.plot(np.delete(vctrl , np.where(f_osc_sttt<=1000)[0]), np.delete(f_osc_sttt , np.where(f_osc_sttt<=1000)[0]), linewidth=2.5, label='sttt')
...
fstt, = ax.plot(np.delete(vctrl , np.where(f_osc_fstt<=1000)[0]), np.delete(f_osc_fstt , np.where(f_osc_fstt<=1000)[0]), linewidth=2.5, label='fstt')
...
tsss, = ax.plot(np.delete(vctrl , np.where(f_osc_tsss<=1000)[0]), np.delete(f_osc_tsss , np.where(f_osc_tsss<=1000)[0]), linewidth=2.5, label='tsss')
tssf, = ax.plot(np.delete(vctrl , np.where(f_osc_tssf<=1000)[0]), np.delete(f_osc_tssf , np.where(f_osc_tssf<=1000)[0]), linewidth=2.5, label='tssf')
tsfs, = ax.plot(vctrl, f_osc_tsfs, linewidth=2.5, label='tsfs')
tsff, = ax.plot(np.delete(vctrl , np.where(f_osc_tsff<=1000)[0]), np.delete(f_osc_tsff , np.where(f_osc_tsff<=1000)[0]), linewidth=2.5, label='tsff')
tstt, = ax.plot(np.delete(vctrl , np.where(f_osc_tstt<=1000)[0]), np.delete(f_osc_tstt , np.where(f_osc_tstt<=1000)[0]), linewidth=2.5, label='tstt')
...
ttsf, = ax.plot(np.delete(vctrl , np.where(f_osc_ttsf<=1000)[0]), np.delete(f_osc_ttsf , np.where(f_osc_ttsf<=1000)[0]), linewidth=2.5, label='ttsf')
ttfs, = ax.plot(vctrl, f_osc_ttfs, linewidth=2.5, label='ttfs')
ttff, = ax.plot(np.delete(vctrl , np.where(f_osc_ttff<=1000)[0]), np.delete(f_osc_ttff , np.where(f_osc_ttff<=1000)[0]), linewidth=2.5, label='ttff')
