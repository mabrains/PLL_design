...
df = pd.read_csv('all_measurements_schematic.csv')
...
df_failed.to_csv("all_measurements_failed_corners_schematic.csv", index=False)
...
#after pex#######
###########
df = pd.read_csv('all_measurements_PEX.csv')
...
# saving the failed corners in a separate list
df_failed = pd.DataFrame(failed_corner)
df_failed.to_csv("all_measurements_failed_corners_PEX.csv", index=False)
