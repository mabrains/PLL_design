...
C {devices/lab_pin.sym} 30 0 0 0 {name=l17 sig_type=std_logic lab=DN}
...
C {devices/lab_pin.sym} 130 130 1 0 {name=l24 sig_type=std_logic lab=VDD
}
C {devices/lab_pin.sym} 120 -30 1 0 {name=l37 sig_type=std_logic lab=VDD
}
...
C {devices/iopin.sym} -390 -570 3 0 {name=p4 lab=VDD}
C {devices/iopin.sym} -370 350 1 0 {name=p5 lab=GND}
C {devices/opin.sym} 180 -180 0 0 {name=p1 lab=VO}
C {devices/ipin.sym} -20 -110 3 0 {name=p2 lab=DN}
C {devices/ipin.sym} -20 -270 1 0 {name=p3 lab=UP}
