...
C {devices/ipin.sym} -600 -40 0 0 {name=p1 lab=V+
}
C {devices/ipin.sym} -590 0 0 0 {name=p2 lab=V-
}
C {devices/opin.sym} -480 -30 0 0 {name=p3 lab=VO}
C {devices/iopin.sym} 1000 -730 0 0 {name=p4 lab=VDD}
C {devices/lab_pin.sym} -40 -750 1 0 {name=l1 sig_type=std_logic lab=VDD
}
C {devices/iopin.sym} 990 -120 0 0 {name=p5 lab=GND}
