...
.save all"}
C {devices/vsource.sym} 3380 -605 0 0 {name=Vin2
value=0.9
}
...
"
spice_ignore=false}
C {/design/pll/pfd_cp_lf_lib/CP/xschem/CP.sym} 3780 -810 0 0 {name=X1}
...
C {devices/vdd.sym} 3840 -840 0 0 {name=l27 lab=VDD}
C {devices/lab_pin.sym} 3880 -840 1 0 {name=l40 sig_type=std_logic lab=U}
