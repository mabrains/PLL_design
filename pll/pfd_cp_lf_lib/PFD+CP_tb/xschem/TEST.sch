...
N 210 230 210 240 {
lab=VDD}
C {devices/vsource.sym} -810 40 0 0 {name=Vdd
value=1.8}
C {devices/gnd.sym} -810 90 0 0 {name=l26 lab=GND}
C {devices/vdd.sym} -810 -20 0 0 {name=l27 lab=VDD}
...
C {sky130_fd_pr/corner.sym} 365 -235 0 0 {name=CORNER only_toplevel=false corner=tt}
C {devices/lab_pin.sym} 160 -10 2 0 {name=l10 sig_type=std_logic lab=Vo
}
C {/home/ahmedelbadry/PFD/PFD.sym} -320 -20 0 0 {name=X2}
...
C {devices/vsource.sym} -480 -30 0 0 {name=V5 
value="pulse(0 1.8 0 10p 10p  12.5ns 25ns)"}
C {devices/gnd.sym} -480 0 0 0 {name=l22 lab=GND}
C {devices/lab_pin.sym} -480 -110 1 0 {name=l23 sig_type=std_logic lab=FB
}
...
C {devices/code_shown.sym} 390 -20 0 0 {name=spice1 only_toplevel=false value=".tran 0.1ns 400ns
.save all"}
...
C {inverter.sym} -2840 720 0 0 {name=X3}
...
C {charge_pump.sym} -30 -20 0 0 {name=X1}
