...
C {devices/vsource.sym} 120 -1250 0 0 {name=VDD value=1.2}
C {devices/gnd.sym} 120 -1220 0 0 {name=l13 lab=GND}
C {devices/vdd.sym} 120 -1280 0 0 {name=l14 lab=VDD}
C {devices/vsource.sym} 200 -1230 0 0 {name=V1 value="pulse(0 1.8 50ps 1ps 1ps  0.5ns 1ns)"}
...
value="pulse(0 1.8 0 1ps 1ps  0.5ns 1ns)"}
C {devices/gnd.sym} 200 -1400 0 0 {name=l17 lab=GND}
C {devices/lab_pin.sym} 200 -1510 1 0 {name=l18 sig_type=std_logic lab=FB
}
C {devices/code_shown.sym} 1490 -980 0 0 {name=spice only_toplevel=false value=".tran 0.001ns 5ns
.save all"}
