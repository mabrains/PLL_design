...
netlist_tmp = os.path.join(os.path.dirname(os.path.abspath(__file__)),"../../test_pfd_behav.sp" ) 
subckt_path = os.path.join(os.path.dirname(os.path.abspath(__file__)),"../../../behav/pfd_behave.ckt" ) 
...
for i in range (0,3):
    ...
    with open(netlist_tmp) as f:
        ...
        with open(file, "w") as netlist:
            netlist.write(tmpl.render(delayup = delayup, delaydwn = delaydwn, line = text , subckt_path = subckt_path, run_folder = run_folder )) 
